...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      {/* Hero */}
      <section className="flex-1 flex items-center justify-center px-4 py-20 bg-gradient-to-br from-blue-50 via-white to-emerald-50 dark:from-blue-950/30 dark:via-background dark:to-emerald-950/30">
        <div className="max-w-2xl text-center">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-4 text-foreground">
            Find Your Next Room
          </h1>
          <p className="text-lg sm:text-xl text-muted mb-8 max-w-lg mx-auto">
            Affordable co-living spaces with everything you need. No brokers, no
            hassle — just quality rooms at fair prices.
          </p>
          <Link
            href="/listings"
            className="inline-flex items-center gap-2 bg-accent text-white font-semibold px-8 py-3 rounded-full text-lg hover:opacity-90 transition-opacity"
          >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-14 h-14 rounded-full bg-blue-100 dark:bg-blue-900/40 text-accent flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                1
              </div>
            ...
            <div className="text-center">
              <div className="w-14 h-14 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-success flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                2
              </div>
            ...
            <div className="text-center">
              <div className="w-14 h-14 rounded-full bg-amber-100 dark:bg-amber-900/40 text-warning flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                3
              </div>
